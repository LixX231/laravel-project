    ...
    <div class="page-wrapper">
        <header>
            <div class="container header-content">
                <a href="{{ route('home') }}" class="logo" aria-label="На главную">
                ...
                <nav>
                    ...
                    <a href="{{ route('array') }}" class="{{ request()->routeIs('array') ? 'active' : '' }}">Массивы</a>
                </nav>
            </div>
        </header>
        ...
        <main class="container content">
            ...
            <div class="actions">
                ...
                <a href="{{ route('array.filter') }}">Цена > 1000 ₽</a>
            </div>
                <div class="grid">
                    @foreach($array as $item)
                        <div class="card">
                            <img 
                                src="{{ Vite::asset('resources/images/' . $item['path']) }}" 
                                alt="{{ $item['title'] }}">
        ...
        <footer>
            <div class="container">
                <p>&copy; Галлямов Максим Денисович 2026</p>
            </div>
        </footer>
    </div>
</body>
